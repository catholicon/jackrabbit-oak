...
public class ElasticsearchIndexProviderService {
    ...
    private void activate(BundleContext bundleContext, Map<String, ?> config) {
        ...
        ElasticsearchCoordinateFactory esCoordFactory = new DefaultElasticsearchCoordinateFactory(connectionFactory, config);

        registerIndexProvider(bundleContext, esCoordFactory);
        registerIndexEditor(bundleContext, esCoordFactory);
    }
    ...
    private void registerIndexProvider(BundleContext bundleContext, ElasticsearchCoordinateFactory esCoordFactory) {
        ElasticsearchIndexProvider indexProvider = new ElasticsearchIndexProvider(esCoordFactory);
    ...
    private void registerIndexEditor(BundleContext bundleContext, ElasticsearchCoordinateFactory esCoordFactory) {
        ElasticsearchIndexEditorProvider editorProvider = new ElasticsearchIndexEditorProvider(esCoordFactory, extractedTextCache);
