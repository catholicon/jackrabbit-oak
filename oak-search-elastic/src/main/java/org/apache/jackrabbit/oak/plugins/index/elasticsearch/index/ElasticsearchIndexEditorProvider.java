...
public class ElasticsearchIndexEditorProvider implements IndexEditorProvider {
    ...
    public ElasticsearchIndexEditorProvider(@NotNull ElasticsearchCoordinateFactory esCoordFactory,
    ...
    public @Nullable Editor getIndexEditor(@NotNull String type,
        ...
        if (TYPE_ELASTICSEARCH.equals(type)) {
            ...
            ElasticsearchIndexWriterFactory writerFactory = new ElasticsearchIndexWriterFactory(esCoordFactory);
