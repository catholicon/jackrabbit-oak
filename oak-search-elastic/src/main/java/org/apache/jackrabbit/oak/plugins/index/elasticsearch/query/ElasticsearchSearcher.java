...
public class ElasticsearchSearcher {
    ...
    ElasticsearchSearcher(@NotNull ElasticsearchCoordinateFactory esCoordFactory, @NotNull ElasticsearchIndexNode indexNode) {
        ElasticsearchIndexDefinition defn = indexNode.getDefinition();
        esIndexCoord = esCoordFactory.getElasticsearchIndexCoordinate(defn);
