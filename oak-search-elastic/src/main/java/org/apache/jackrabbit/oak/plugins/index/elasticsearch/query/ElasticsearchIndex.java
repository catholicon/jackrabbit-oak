...
public class ElasticsearchIndex extends FulltextIndex {
    ...
    ElasticsearchIndex(@NotNull ElasticsearchCoordinateFactory esCoordFactory, @NotNull NodeState root) {
    ...
    public Cursor query(IndexPlan plan, NodeState rootState) {
        ...
        Iterator<FulltextResultRow> itr = new ElasticsearchResultRowIterator(esCoordFactory,
                filter, pr, plan,
